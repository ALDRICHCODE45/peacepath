...
export const GoalCard = ({
  ...
  return (
    <Card className="animate__animated animate__fadeInDown relative dark:bg-[#181a1b] rounded-lg p-4 flex flex-col items-center justify-between border dark:border-[#363b3d] w-80 h-60 ">
