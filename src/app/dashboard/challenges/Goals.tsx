...
export default function Goals({ initialGoals }: Props) {
  ...
  return (
    <>
      ...
      <div className="animate__animated animate__fadeInRight text-foreground rounded-lg p-6 w-full max-w-7xl mx-auto bg-[#ffffff] dark:bg-[#181a1b] ">
        ...
        {!initialGoals.length ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 w-full h-[calc(100vh-300px)] gap-5 overflow-y-scroll p-3">
