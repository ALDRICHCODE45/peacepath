...
export function CanvasRevealEffectDemo() {
  return (
    <>
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-[#18181b] w-full gap-4 mx-auto px-8">
        <Card title="YOU ARE IMPORTANT" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="YOU ARE ENOUGH" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="DON'T GIVE UP" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
